...
You're given some starting HTML and CSS. 
- Add your own touch: text, images, colors etc.
- The page is not optimized for small screen. Make the necessary modifications to create a fully responsive page. You can use either Flexbox or Grid layout.
